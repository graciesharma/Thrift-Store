...
const priceMarks = {
  1: { label: <p className="fw-normal text-black">Rs1</p> },
  5000: { label: <p className="fw-normal text-black">Rs5000</p> },
};
...
const ProductFilter = (props) => {
  ...
  return (
    <div className="product-filter">
      ...
      <Card>
        <CardHeader tag="h3">Tag</CardHeader>
        <CardBody>
          <div className="mx-2 mb-4">
            <SelectOption
