    ...
    <div className="order-meta">
      ...
      <Row>
        ...
        <Col xs="12" md="8" className="mt-4">
          <Row>
            <Col xs="4">
              <p className="one-line-ellipsis">User Name</p>
            </Col>
            <Col xs="8">
              <span className="order-label one-line-ellipsis">{` ${order.userInfo.firstName} ${order.userInfo.firstName}`}</span>
            </Col>
          </Row>
          <Row>
            <Col xs="4">
            ...
            <Col xs="8">
              <span className="order-label one-line-ellipsis">{` ${order.userInfo.email}`}</span>
            </Col>
          </Row>
          <Row>
            <Col xs="4">
            ...
            <Col xs="8">
              <span className="order-label one-line-ellipsis">{` ${
                order.userInfo.phoneNumber ? order.userInfo.phoneNumber : "-"
              }`}</span>
            </Col>
          </Row>
        </Col>
