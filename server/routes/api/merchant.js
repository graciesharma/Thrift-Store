...
router.post("/add", async (req, res) => {
  try {
    const { name, business, phoneNumber, email, brandName, password } =
      req.body;
    ...
    res.status(200).json({
      success: true,
      message: `We received your request! wait until you’re verified by our admin, till then check about us.`,
...
const createMerchantUser = async (email, name, password, merchant, host) => {
